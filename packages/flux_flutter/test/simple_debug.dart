...
""";
  ...
  try {
    ...
    if (paused) {
      ...
      final localsResponse =
          await FluxServiceExtensionHandlers.getLocals(vm, {'frameIndex': '0'});
      ...
      if (locals.containsKey('list')) {
        ...
        if (handle != null) {
          final objRes = await FluxServiceExtensionHandlers.getObject(
              vm, {'handle': handle.toString()});
