...
void main() {
  group('FluxProfiler', () {
    ...
    test('records instructions', () {
      ...
      expect(report.totalInstructions, greaterThan(0),
          reason: "Instructions should be > 0");
    });
    ...
    test('records script profile', () {
      ...
      final scriptProfile = report.functionProfiles.firstWhere(
          (p) => p.name == 'script',
          orElse: () => FunctionProfile('NOT_FOUND'));
