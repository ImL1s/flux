...
class FluxModule {
  ...
  final Map<String, dynamic> members =
      {}; // NativeFunction or AsyncNativeFunction
...
class StdLib {
  ...
  static void _registerHttpModule() {
    ...
    httpModule.register(
        'get',
        AsyncNativeFunction('http.get', 1, (args) async {
    ...
    httpModule.register(
        'post',
        AsyncNativeFunction('http.post', 2, (args) async {
          final url = Uri.parse(args[0] as String);
          final body = args[1];
  ...
  static void _registerJsonModule() {
    ...
    jsonModule.register(
        'parse',
        NativeFunction('json.parse', 1, (args) {
    ...
    jsonModule.register(
        'stringify',
        NativeFunction('json.stringify', 1, (args) {
          final obj = args[0];
          try {
  ...
  static void _registerTimerModule() {
    ...
    timerModule.register(
        'delay',
        AsyncNativeFunction('timer.delay', 1, (args) async {
  ...
  static void _registerCryptoModule() {
    ...
    cryptoModule.register(
        'sha256',
        NativeFunction('crypto.sha256', 1, (args) {
    ...
    cryptoModule.register(
        'randomBytes',
        NativeFunction('crypto.randomBytes', 1, (args) {
  ...
  static void _registerBase64Module() {
    ...
    base64Module.register(
        'encode',
        NativeFunction('base64.encode', 1, (args) {
          final data = args[0] as String;
    ...
    base64Module.register(
        'decode',
        NativeFunction('base64.decode', 1, (args) {
  ...
  static void _registerRegexModule() {
    ...
    regexModule.register(
        'test',
        NativeFunction('regex.test', 2, (args) {
    ...
    regexModule.register(
        'match',
        NativeFunction('regex.match', 2, (args) {
          final pattern = args[0] as String;
          final input = args[1] as String;
          try {
            final regex = RegExp(pattern);
    ...
    regexModule.register(
        'matchAll',
        NativeFunction('regex.matchAll', 2, (args) {
          final pattern = args[0] as String;
          final input = args[1] as String;
          try {
            final regex = RegExp(pattern);
    ...
    regexModule.register(
        'replace',
        NativeFunction('regex.replace', 3, (args) {
          final pattern = args[0] as String;
          final input = args[1] as String;
  ...
  static void _registerDateModule() {
    ...
    dateModule.register(
        'now',
        NativeFunction('date.now', 0, (args) {
          return DateTime.now().millisecondsSinceEpoch;
        }));

    dateModule.register(
        'format',
        NativeFunction('date.format', 2, (args) {
          ...
          var result = format;
          result =
              result.replaceAll('yyyy', dt.year.toString().padLeft(4, '0'));
          ...
          result =
              result.replaceAll('mm', dt.minute.toString().padLeft(2, '0'));
          result =
              result.replaceAll('ss', dt.second.toString().padLeft(2, '0'));
          return result;
        }));

    dateModule.register(
        'parse',
        NativeFunction('date.parse', 1, (args) {
    ...
    dateModule.register(
        'year',
        NativeFunction('date.year', 1, (args) {
          final timestamp = args[0] as int;
    ...
    dateModule.register(
        'month',
        NativeFunction('date.month', 1, (args) {
          final timestamp = args[0] as int;
    ...
    dateModule.register(
        'day',
        NativeFunction('date.day', 1, (args) {
          final timestamp = args[0] as int;
