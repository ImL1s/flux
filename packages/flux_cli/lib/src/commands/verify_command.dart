...
class VerifyCommand extends Command {
  ...
  @override
  final String description = 'Verify a Flux script signature using a public key.';
  ...
  Future<void> run() async {
    ...
    if (isValid) {
      print('VERIFIED: The script signature is valid and content is untampered.');
      exit(0);
    } else {
      stderr.writeln('FAILED: Verification failed. The script may be tampered or signature invalid.');
      exit(1);
    }
  }
}
